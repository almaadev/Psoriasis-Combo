    ...
    <div class="grid grid-cols-1 gap-10 md:grid-cols-2 md:p-5">
      ...
      <div class="product-left md:p-5">
        <div class="main-image-wrapper relative overflow-hidden cursor-zoom-in">
          <div class="image-slider flex transition-transform duration-500" id="sliderTrack">
            <img alt="Almaa Psoriasis Combo" src="assets/Product-image/Psoriasis-Combo.webp"
              class="slide w-full flex-shrink-0 rounded-2xl">
            <img alt="Almaa Psoriasis Combo" src="assets/Product-image/Psoriasis combo Ingrediants.webp"
              class="slide w-full flex-shrink-0 rounded-2xl">
            <img alt="Almaa Psoriasis Combo" src="assets/Product-image/Key benefits of the Psoriasis combo.webp"
              class="slide w-full flex-shrink-0 rounded-2xl">
            <img alt="Almaa Psoriasis Combo" src="assets/Product-image/Psoriasis combo How to use.webp"
              class="slide w-full flex-shrink-0 rounded-2xl">
            <img alt="Almaa Psoriasis Combo" src="assets/Product-image/Psoriasis combo Product info.webp"
              class="slide w-full flex-shrink-0 rounded-2xl">
          </div>
        </div>
        ...
        <div class="thumb-row flex gap-3 mt-10">
          <img alt="Almaa Psoriasis Combo" src="assets/Product-image/Psoriasis-Combo.webp" class="thumb" data-index="0">
          <img alt="Almaa Psoriasis Combo" src="assets/Product-image/Psoriasis combo Ingrediants.webp" class="thumb"
            data-index="1">
          <img alt="Almaa Psoriasis Combo" src="assets/Product-image/Key benefits of the Psoriasis combo.webp"
            class="thumb" data-index="2">
          <img alt="Almaa Psoriasis Combo" src="assets/Product-image/Psoriasis combo How to use.webp" class="thumb"
            data-index="3">
          <img alt="Almaa Psoriasis Combo" src="assets/Product-image/Psoriasis combo Product info.webp" class="thumb"
            data-index="4">
        </div>
      </div>
      ...
      <div id="lightbox" class="fixed inset-0 bg-black/90 hidden items-center justify-center z-50">
        ...
        <button id="closeLightbox"
          class="absolute top-4 right-1 md:right-6 text-white text-3xl md:text-5xl rounded-full px-3 pb-2 text-center flex justify-center">&times;</button>
        <!-- Counter -->
        ...
        <!-- Prev -->
        <button id="prevBtn"
          class="hidden md:flex absolute left-6 text-white text-4xl bg-white/10 px-4 py-1 rounded-full">&#10094;</button>
        <!-- Image -->
        <div id="lightboxslider"
          class="md:w-[80%] md:h-[80%] flex justify-center items-center transition duration-300 p-1">
          <img id="lightboxImage" class="max-h-[100%] max-w-[100%] rounded-xl">
        </div>
        <!-- Next -->
        <button id="nextBtn"
          class="hidden md:flex absolute right-6 text-white text-4xl bg-white/10 px-4 py-1 rounded-full">&#10095;</button>
      </div>
      ...
      <div class="space-y-5 md:p-5 rounded-3xl">
        ...
        <div>
          ...
          <p class="text-gray-600 mt-2">
            ...
            Herbal Support for Itching & Scaling | Traditional Skin Wellness Approach | Suitable for Long-Term Skin
            Wellness | Internal + External Siddha Care
        ...
        <div class="w-[70%]">
          ...
          <div class="grid grid-cols-2 gap-2">
            ...
            <!-- Pack 1 -->
            <button
              class="pack-btn border border-greentext text-white bg-greentext/80 hover:scale-105 text-center transition"
              data-pack="1" data-price="<?php echo $product_price; ?>" data-old="<?php echo $product_old_price; ?>">
