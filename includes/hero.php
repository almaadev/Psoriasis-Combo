...
<section id="home" class="h-[90vh] relative overflow-hidden group">
  ...
  <div id="heroSlider" class="flex h-full transition-transform duration-700 ease-in-out">
    ...
    <a href="./checkout.php" class="relative block min-w-full overflow-hidden">
      <!-- Image -->
      <picture>
        <source media="(max-width:768px)" srcset="assets/banner-image/mobile-banner1.webp"
          class="max-w-full h-auto object-cover">
        <img src="assets/banner-image/Psoriasis combo Siled.webp" alt="banner"
          class="min-w-full h-full object-cover object-center">
      </picture>
      <!-- Overlay -->
      <div
        class="absolute inset-0 flex items-end justify-center pb-20 md:items-center md:justify-start md:pb-0 md:py-0">
        <div
          class="max-w-xl px-6 md:px-10 lg:ml-20 xl:ml-32 text-center md:text-left space-y-4 md:space-y-6 lg:space-y-8">
          <!-- Heading -->
    ...
    <a href="./checkout.php" class="block min-w-full relative">
      <picture>
        <source media="(max-width:768px)" srcset="assets/banner-image/mobile-banner2.webp"
          class="max-w-full h-auto object-cover">
        <img src="assets/banner-image/Psoriasis-banner-edited.webp" alt="banner-img2"
          class="min-w-full bg-cover h-full">
      </picture>
    ...
    <a href="./checkout.php" class="block min-w-full relative">
      <picture>
        <source media="(max-width:768px)" srcset="assets/banner-image/mobile-banner3.webp"
          class="max-w-full h-auto object-cover">
        <img src="assets/banner-image/product-banner.webp" alt="banner-img3" class="min-w-full bg-cover h-full">
      </picture>
  ...
  <button id="prev-btn"
    class="hidden md:flex absolute top-[50%] left-[5%] text-3xl px-3 py-1 text-white/0 group-hover:text-white/90 rounded-full font-bold z-50 hoverEffect">
    &#10094;
  </button>
  <button id="next-btn"
    class="hidden md:flex absolute top-[50%] right-[5%] text-3xl px-3 py-1 text-white/0 group-hover:text-white/90 rounded-full font-bold z-50 hoverEffect">
    &#10095;
  </button>
  <!-- DOTS -->
